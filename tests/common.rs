...
#[allow(dead_code)]
pub const REFERENCE_HASHES: [(&str, &str); 12] = [
    (
        "basic_test",
    ...
    (
        "quadbezier_test",
        "391B95BA22130FFD21A40605267E00629AD131F5103B67390ABEDE4BE1B1F9A9",
    ),
    (
        "quadbezier_font_test",
        "9AD1B569C2BACD1EF8286C09A33F60117A2DFE494EECDBB56D93CE3679C8A4B7",
    ),
];
